...
export async function handler(chatUpdate) {
    ...
    // Eliminamos esta línea para permitir que el bot funcione en grupos y chats privados
    // if (!chatUpdate.isGroup) return // Solo procesar mensajes de chat grupales
    ...
    try {
        ...
        const isPrems = isROwner || global.prems.includes(m.sender) || _user.premium
        ...
        for (let name in global.plugins) {
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                    conn.reply(m.chat, `⚠️ Se agotaron tus *💰 Coins*`, m)
                    continue
                }
                let extra = {
                    match,
...
global.dfail = (type, m, conn, usedPrefix) => {
    let msg = {
        rowner: `🔰 Hola, este comando solo puede ser utilizado por el *Creador* de Admin-TK.`,
        owner: `🔰 Hola, este comando solo puede ser utilizado por el *Creador* de Admin-TK y los *Sub Bots*.`,
        mods: `🔰 Hola, este comando solo puede ser utilizado por los *Moderadores* de Admin-TK.`,
        premium: `💎 Hola, este comando solo puede ser utilizado por Usuarios *Premium* de Admin-TK.`,
        ...
        botAdmin: `⚠️ Hola, Admin-TK debe ser *Administrador* para ejecutar este comando.`,
        unreg: `┏━━━━━━━━━━━━━━━━━━━━━━━✨🔰✨━━━━━━━━━━━━━━━━━━━━━━━┓
   🔰 Hola, para usar este comando debes estar *registrado* en Admin-TK.
   🔰 Para registrarte usa: *.reg nombre.edad*
   🔰 Ejemplo: *.reg Joan.18*
┗━━━━━━━━━━━━━━━━━━━━━━━✨🔰✨━━━━━━━━━━━━━━━━━━━━━━━┛`,
        restrict: `🔰 Hola, esta característica está *deshabilitada* por el momento.`  
    }[type]
...
watchFile(file, async () => {
    unwatchFile(file)
    console.log(chalk.magenta("🔄 Admin-TK: Se actualizó 'handler.js'"))
